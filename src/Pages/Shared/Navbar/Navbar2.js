...
const Navbar2 = () => {
  ...
  <li class="block p-2 hover:bg-gray-200 transition duration-300">Menu
  <ul class="absolute hidden space-y-1 bg-white shadow-md mt-2 w-36 group-hover:block">
    <li>
      <NavLink to="/canteen" class="block p-2 hover:bg-gray-200">Canteen</NavLink>
    </li>
    <li>
      <NavLink to="/dining" class="block p-2 hover:bg-gray-200">Dining</NavLink>
    </li>
  </ul>
  </li>
</li>
    ...
    <div className="sticky bg-cyan-50 top-0 z-50  navbar md:px-10 lg:px-15  flex justify-between items-center">
      <div className="navbar-start">
        ...
        <NavLink to="/" className="flex   items-center lg:mx-20 md:mx-10">
          ...
          <span className="text-[blue] text-2xl  ">JU-Feast</span>
        </NavLink>
      </div>
