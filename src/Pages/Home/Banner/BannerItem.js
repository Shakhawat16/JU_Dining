    ...
    <div id={`slide${id}`} className="carousel-item relative w-full">
      ...
      <div className="absolute flex justify-end transform -translate-y-1/2 left-24 top-1/4">
        <h1 className="text-6xl font-bold text-white">
          Jahangirnagar University <br/> Hall Coupon Management System<br />
        </h1>
      </div>
      <div className="absolute flex justify-end transform -translate-y-1/2 w-2/4 left-24 top-1/2">
        <p className="text-xl text-white">
          Jahangirnagar University maintains hall coupon for all students. There are
          always students in the 22 halls. Each hall offers the students
          and teachers a healthy and fresh meal in morning and lunch time in
          very low cost. There are 20+ staffs and cookers helping to serve the
          food and maintaining the menus on each hall.
        </p>
      </div>
